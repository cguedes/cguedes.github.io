  ...
  courses: [
    ...
    new LectiveSemesterCourses('2s0708', [
      ...
      new Course(
        ...
        '4th',
        'http://www.deetc.isel.ipl.pt/sinfoconhecimento/licenciatura/si1/'
      )
    ]),
    new LectiveSemesterCourses('1s0708', [new Course('CG', 'Computação Gráfica', 'optional, of 3rd/5th')]),
    new LectiveSemesterCourses('2s0607', [new Course('Pg', 'Programação', '1st')]),
    ...
    new LectiveSemesterCourses('2s0506', [
      ...
      new Course(
        ...
        '6th',
        'http://www.deetc.isel.ipl.pt/programacao/Programacao_Inv_2005_2006/TI/'
      )
    ]),
    ...
    new LectiveSemesterCourses('2s0405', [new Course('Pg2', 'Programação 2 - Informática', '6th')])
  ]
}
